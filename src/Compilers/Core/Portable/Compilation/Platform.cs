...
namespace Microsoft.CodeAnalysis
{
    public enum Platform
    {
        ...
        /// <summary>
        /// Compiles your assembly to run on a computer that has an Advanced RISC Machine 64 bit (MIPS64) processor.
        /// </summary>
        Mips64 = 7,
    };
    ...
    internal static partial class EnumBounds
    {
        ...
        {
            return value >= Platform.AnyCpu && value <= Platform.Mips64;
        }

        internal static bool Requires64Bit(this Platform value)
        {
            return value == Platform.X64 || value == Platform.Itanium || value == Platform.Arm64 || value == Platform.Mips64;
        }
